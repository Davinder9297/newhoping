...
setcourses(response)
    ...
    return (
        <>
            ...
            <div className="h-[100%] w-full px-20 pt-5 mt-10 font-outfit bg-[#EBEBFF] 2xl:h-[60vh]">
                ...
                <div className="text-4xl font-outfit font-semibold mt-3">{selectedCategory}</div>
                ...
                <div className="grid grid-cols-4 gap-5  justify-center mt-5 flex-wrap xsm:grid xsm:grid-cols-2 pb-5"> {/* Changed flex to flex-wrap */}
